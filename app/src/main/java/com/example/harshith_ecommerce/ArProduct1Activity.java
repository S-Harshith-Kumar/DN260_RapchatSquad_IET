...
public class ArProduct1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ar_product1);
...
//    }
    ...
    private void removeAnchorNode(AnchorNode nodeToremove) {
        ...
        if (nodeToremove != null) {
            ...
            nodeToremove = null;
            Toast.makeText(ArProduct1Activity.this, "Product removed", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(ArProduct1Activity.this, "Test Delete - markAnchorNode was null", Toast.LENGTH_SHORT).show();
        }
    }
}

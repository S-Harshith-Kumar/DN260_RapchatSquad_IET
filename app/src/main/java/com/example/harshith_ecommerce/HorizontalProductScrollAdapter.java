...
public class HorizontalProductScrollAdapter extends RecyclerView.Adapter<HorizontalProductScrollAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(final String productId, String resourse, String title, String description, String price){
            Glide.with(itemView.getContext()).load(resourse).apply(new RequestOptions().placeholder(R.mipmap.icon_placeholder)).into(productImage);

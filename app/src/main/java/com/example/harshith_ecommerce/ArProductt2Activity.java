...
public class ArProductt2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ar_productt2);
...
//    }
    ...
    private void removeAnchorNode(AnchorNode nodeToremove) {
        ...
        if (nodeToremove != null) {
            ...
            nodeToremove = null;
            Toast.makeText(ArProductt2Activity.this, "Product removed", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(ArProductt2Activity.this, "Test Delete - markAnchorNode was null", Toast.LENGTH_SHORT).show();
        }
    }
}
